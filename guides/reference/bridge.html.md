...
You can find an introduction for this in the payment form documentation. Besides this, you can integrate the following code on your page:
...
In order to validate the data from your website, you simply use the validation features integrated in PAYMILL. For example, your credit card number and the expiration date are verified here. You can find detailed information on this in the payment form.
...
**Note:** the parameters have to be passed using a POST request.
...
The following browsers support 3-D Secure transactions:
  ...
  - IE 9+ (IE8 in native WinXP environment)
  - Chrome Current
  - Safari Current
  - Firefox Current
</p>
